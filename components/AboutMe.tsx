          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="flex flex-col order-2 text-center md:text-left">
              <p className="text-gray-300 text-base sm:text-lg mb-4 leading-relaxed">
                Hello! I am Krishtina Maharjan, a passionate Software Developer
                based in Nepal. I enjoy creating things that live on the
              ...
              <p className="text-gray-300 text-base sm:text-lg mb-8 leading-relaxed">
                ...
                high-performance frontends in React and Next.js to architecting
                scalable backends with Django and Node.js, I focus on writing
                clean, maintainable code that bridges the gap between complex
